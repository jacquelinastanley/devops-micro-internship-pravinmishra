...
![screenshot](screenshots/W6-A4-T3-S6.png) 

---

#### Screenshot 7 — Terminal showing a successful SSH login with the `ubuntu@...` prompt

![screenshot](screenshots/W6-A4-T3-S7.png) 
...
![screenshot](screenshots/W6-A4-T4-S8.png) 

---

#### Screenshot 9 — Output of `systemctl status nginx`

![screenshot](screenshots/W6-A4-T4-S9.png) 

---

#### Screenshot 10 — Output of `mysql --version`

![screenshot](screenshots/W6-A4-T4-S10.png) 
...
![screenshot](screenshots/W6-A4-T6-S13.png) 
...
![screenshot](screenshots/W6-A4-T8-S17.png) 

---

#### Screenshot 18 — Nginx configuration snippet showing the `/api/` reverse proxy

![screenshot](screenshots/W6-A4-T8-S18.png) 
