...
---
### Troubleshoot 1
I encountered an InvalidKeyPair.NotFound error because the EC2 key pair referenced in Terraform did not exist in the AWS Region being used. 

![alt text](screenshots/image-22.png)

I verified the configured Region, created the epicbook-jacquelina-key key pair in the correct Region, saved the private .pem file locally, and secured it with the correct permissions. After confirming that the key name matched the Terraform configuration, I reran terraform apply successfully.
...
**EC2 Public IP URL:** http://13.222.64.123/
